...
public class VoteServiceTest {
    ...
    public void create(){
        ...
        VOTE_MATCHER.assertMatch(service.get(newId,  USER_ID, RESTAURANT_ID), newVote);
    }

    @Test
    public void delete(){
        service.delete(CREATED_VOTE_ID, USER_ID, RESTAURANT_ID);
        assertThrows(NotFoundException.class, () -> service.get(CREATED_VOTE_ID, USER_ID, RESTAURANT_ID));
    }
    ...
    public void update(){
        ...
        VOTE_MATCHER.assertMatch(service.get(VOTE_ID + 1, USER_ID + 1, RESTAURANT_ID + 1), getUpdated());
    }

    @Test
    public void deleteNotFound() {
        assertThrows(NotFoundException.class, () -> service.delete(NOT_FOUND, USER_ID, RESTAURANT_ID));
    }

    @Test
    public void get() {
        Vote vote = service.get(VOTE_ID, USER_ID, RESTAURANT_ID);
        VOTE_MATCHER.assertMatch(vote, VOTE_1);
    }

    @Test
    public void getNotFound() {
        assertThrows(NotFoundException.class, () -> service.get(NOT_FOUND, USER_ID, RESTAURANT_ID));
    }
